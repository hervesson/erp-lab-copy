...
import { Book, Calendar, Edit2, More, SearchStatus } from 'iconsax-reactjs'
      ...
      <div>
        <div className="flex h-[64px] items-end gap-8 bg-[#F9F9F9] px-[48px]">
          ...
          <button
            ...
            className={`${Outfit400.className} ${page === 'equipamentos' && 'border-b-2 border-[#0F9B7F] bg-white'} h-[56px] rounded-tl-[8px] rounded-tr-[8px] px-2 text-[16px] text-[#222] uppercase`}
          >
            Especialidades
          </button>
          <button
            ...
            className={`${Outfit400.className} ${page === 'profissionais' && 'border-b-2 border-[#0F9B7F] bg-white'} h-[56px] rounded-tl-[8px] rounded-tr-[8px] px-2 text-[16px] text-[#222] uppercase`}
          >
            Profissionais
          </button>
          <button
            type="button"
            onClick={() => setPage('salas')}
            className={`${Outfit400.className} ${page === 'salas' && 'border-b-2 border-[#0F9B7F] bg-white'} h-[56px] rounded-tl-[8px] rounded-tr-[8px] px-2 text-[16px] text-[#222] uppercase`}
          >
            Salas
          </button>
        </div>
