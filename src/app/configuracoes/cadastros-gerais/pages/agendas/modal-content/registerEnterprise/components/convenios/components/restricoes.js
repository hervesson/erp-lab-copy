...
const Restricoes = ({ formik, fields }) => {
  return (
          ...
          <div className="flex flex-col gap-[16px]">
            <div className="flex gap-[16px]">
              <div className="flex flex-1 flex-col gap-[4px]">
                ...
                >
                  Tipo de restrição<strong className="text-[#F23434]">*</strong>
                </label>
            ...
            <div className="flex gap-[16px]">
              ...
              <div className="flex flex-1 flex-col gap-[4px]">
                <label
                  className={`${Outfit400.className} text-[14px] text-[#222222]`}
                >
                  Médico<strong className="text-[#F23434]">*</strong>
                </label>
                <div className="flex w-full items-center gap-2">
                  <input
                    {...formik.getFieldProps('sinonimos')}
            ...
            <div className="flex gap-[16px]">
              ...
              <div className="flex flex-1 flex-col gap-[4px]">
                <label
                  className={`${Outfit400.className} text-[14px] text-[#222222]`}
                >
                  Setor solicitante<strong className="text-[#F23434]">*</strong>
                </label>
                <div className="flex w-full items-center gap-2">
                  <input
                    {...formik.getFieldProps('sinonimos')}
            ...
            <div className="flex gap-[16px]">
              ...
              <div className="flex flex-1 flex-col gap-[4px]">
                <label
                  className={`${Outfit400.className} text-[14px] text-[#222222]`}
                >
                  Citog<strong className="text-[#F23434]">*</strong>
                </label>
                <div className="flex w-full items-center gap-2">
                  <input
                    {...formik.getFieldProps('sinonimos')}
              ...
              <div className="flex flex-1 flex-col gap-[4px]">
                <label
                  className={`${Outfit400.className} text-[14px] text-[#222222]`}
                >
                  Unidade<strong className="text-[#F23434]">*</strong>
                </label>
                <div className="flex w-full items-center gap-2">
                  <input
                    {...formik.getFieldProps('sinonimos')}
