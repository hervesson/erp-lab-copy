...
import { AddSquare, SearchStatus } from 'iconsax-reactjs'
...
const SalasSetores = ({ openModalRegisteUnits, setModalRegisterUnits }) => {
        ...
        <div className="flex flex-1 gap-3 rounded-[8px] px-[16px]">
          <div className="flex flex-1 items-center justify-around gap-[16px]">
            ...
            <input
              ...
              className={`h-full rounded-[8px] ${Outfit400.className} border border-[#BBBBBB] bg-[#FFF] px-2 text-[16px] text-[#222] outline-0`}
            />
            <button
              type="botton"
