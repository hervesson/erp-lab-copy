  ...
  (
    ...
    const formik = useFormik({
      ...
      onSubmit: async (values) => {
        setLoading(true)
        const payload = {
          tipoEmpresa: 'LABORATORIO_APOIO', // "CONVENIOS", LABORATORIO_APOIO", "TELEMEDICINA", "FORNECEDORES", "PRESTADORES_SERVICOS"
...
LaboratorioDeApoio.displayName = 'ChildComponentPatiente'
