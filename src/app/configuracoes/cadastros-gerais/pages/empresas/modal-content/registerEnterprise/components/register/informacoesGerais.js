  ...
  return (
    <div className="mx-[48px] my-[28px] flex h-fit flex-1 flex-col rounded">
      <div className="flex h-[56px] items-center gap-8 px-[48px]">
        <button
          type="button"
          className={`${Outfit400.className} h-[56px] rounded-tl-[8px] rounded-tr-[8px] border-b-2 border-[#0F9B7F] bg-white px-2 text-[16px] text-[#222]`}
        >
          INFORMAÇÕES GERAIS
        </button>
      </div>
              ...
              <div className="flex gap-[16px]" key={index.toString()}>
                ...
                <div className="flex flex-col gap-[4px]">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFin(index, 'digitoConta', e.target.value)
                    }
                    className={`${Outfit400.className} ring-none flex h-[40px] items-center justify-center rounded-[8px] border-1 border-[#A9A9A9] px-2 text-[#494949] outline-none hover:border-[#0F9B7F] focus:border-[#0F9B7F]`}
                    placeholder="Digite o dígito da agência"
                  />
          ...
          <div className="flex gap-[16px]">
            <div className="flex w-full flex-col gap-[4px]">
              ...
              <CustomSelect
                ...
                className={'max-w-[250px] border border-[#BBBBBB]'}
              />
            </div>
          </div>
        </div>
